...
public class SistemaOperativoTest {
	...
	public void arribosAlMismoTiempo() {
		...
		public void datosNulos() { 
			...
			Proceso p0 = new Proceso("P0", -1, -3, -2);
			Proceso p1 = new Proceso("P1", -8, -4, -7);
			Proceso p2 = new Proceso("P2", -3, -6, -5);
			Proceso p3 = new Proceso("P3", -3, -2, -1);
			Proceso p4 = new Proceso("P4", -4, -3, -2);
		...
		@Test
		public void chequearOrdenDeSalida() {
			Proceso p0 = new Proceso("P0", 0, 5, 4);
			Proceso p1 = new Proceso("P1", 1, 3, 2);
			Proceso p2 = new Proceso("P2", 2, 8, 5);
			Proceso p3 = new Proceso("P3", 3, 2, 1);
			...
			System.out.println(so.listarProcesosSalida());
		}
		
		@Test (expected = AssertionError.class)
		public void todosLosProcesosSonIguales() {
			Proceso p0 = new Proceso("P0", 2, 2, 2);
			Proceso p1 = new Proceso("P0", 2, 2, 2);
			Proceso p2 = new Proceso("P0", 2, 2, 2);
			Proceso p3 = new Proceso("P0", 2, 2, 2);
			Proceso p4 = new Proceso("P0", 2, 2, 2);
